...
/**
 * ¿Está vivo el checkout? Comprobado el 2026-08-12:
 *   curl -sI https://pay.hotmart.com/A106414286A | head -1  →  HTTP/2 200
 * (hasta el 2026-07-29 respondía 307 → `/error?errorMessage=049`). El precio
 * base quedó configurado en Hotmart: COP 129.900.
 *
 * Con esto en `true`, `/academia` entra al sitemap y se indexa. Si el checkout
 * vuelve a romperse, poner `false` es el único cambio necesario.
 */
export const CHECKOUT_ACTIVO = true;
...
export const CURSO = {
  ...
  precio: {
    // Igual al precio base configurado en Hotmart (verificado 2026-08-12).
    lanzamiento: "129.900",
    normal: "199.000",
    moneda: "COP",

  ...
  "agentes-ia": {
    ...
    secciones: {
      ...
      porQue: {
        titulo: "No es un bot",
        em: "cualquiera.",
        lead: "Lo que separa un agente que vende de un chatbot que responde: con qué se entrena, cuándo se calla y a quién te pasa el cliente.",
      },
  ...
  software: {
    ...
    secciones: {
      ...
      porQue: {
        titulo: "El código",
        em: "es tuyo.",
        lead: "Te entregamos el código y la documentación. Si mañana quieres seguir con otro equipo, puedes — y eso es justamente lo que nos obliga a hacerlo bien.",
      },
  ...
  marca: {
    ...
    secciones: {
      ...
      porQue: {
        titulo: "Una marca",
        em: "de verdad.",
        lead: "No es publicar por publicar: es un sistema que se sostiene solo y sigue pareciéndose a ti en la pieza número trescientos.",
      },
